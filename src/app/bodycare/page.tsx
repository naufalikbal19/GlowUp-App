  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Bodycare</h1>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Analisa kondisi kulit tubuh & routine mingguan yang dipersonalisasi.
          </p>
        </div>
        <LinkButton href="/bodycare/analyze">
      ...
      {!latest ? (
        <EmptyState
          ...
          description="Upload foto tubuh atau isi kuisioner untuk mendapatkan routine bodycare mingguan pertamamu."
          action={<LinkButton href="/bodycare/analyze">Mulai Analisa</LinkButton>}
        />
      ) : (
        <>
          <Card className="flex flex-col gap-3 sm:flex-row">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-wrap items-center gap-2">
                <Badge tone="purple">{latest.skinType}</Badge>
